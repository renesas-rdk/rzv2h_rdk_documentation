...
* Convert the models to ONNX format (using NCHW layout):
  ...
  .. code-block:: bash
      ...
      $ python -m tf2onnx.convert --tflite hand_landmark_full.tflite --opset 12 --output hand_landmark_full.onnx --inputs-as-nchw input_1
      $ python -m tf2onnx.convert --tflite palm_detection_full.tflite --opset 12 --output palm_detection_full.onnx --inputs-as-nchw input_1

* For the Lite version, use:

  .. code-block:: bash

      $ python -m tf2onnx.convert --tflite hand_landmark_lite.tflite --opset 12 --output hand_landmark_lite.onnx --inputs-as-nchw input_1
      $ python -m tf2onnx.convert --tflite palm_detection_lite.tflite --opset 12 --output palm_detection_lite.onnx --inputs-as-nchw input_1
