AgileX Piper Arm Packages
--------------------------

A collection of ROS 2 packages for controlling and interfacing with the AgileX Piper robotic arm, including:

- agilex_piper_arm_bringup: ROS 2 package that provides launch files, controller configurations, robot descriptions, and test scripts for the AgileX Piper arm and gripper.
...
- agilex_piper_ros2_control: ROS 2 package that provides a ros2_control hardware interface for the AgileX Piper arm and gripper.
